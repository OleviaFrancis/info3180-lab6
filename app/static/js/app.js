    ...
    created: function() {
        ...
        fetch('https://newsapi.org/v2/top-headlines?country=us&apiKey=c2f9fdcde21c4d08bbf0dcd9a404f698') .then(function(response) {
            ...
            methods: {
                searchNews: function() {
                    let self = this;
                     fetch('https://newsapi.org/v2/everything?q='+self.searchTerm + '&language=en&apiKey=c2f9fdcde21c4d08bbf0dcd9a404f698') .then(function(response){
                         return response.json();
                    })
                    .then(function(data) {
                         console.log(data);
...
const router = new VueRouter({
    mode: 'history', routes: [{ path: '/', component: Home }, { path: '/news', component: NewsList }]
